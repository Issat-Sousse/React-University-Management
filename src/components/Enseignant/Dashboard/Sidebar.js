  ...
  return (
    <Box
      sx={{
        ...
        "& .pro-sidebar-inner": {
          background:
            "linear-gradient(180deg, #1B61B3 0%, #071F3C 99.96%, #061E39 99.97%, #061C35 99.98%, #051A33 99.99%, rgba(32, 98, 176, 0) 100%, rgba(32, 98, 176, 0) 100%) !important",
      ...
      <ProSidebar collapsed={isCollapsed}>
        <Menu iconShape="square">
          ...
          <MenuItem
            ...
            icon={
              isCollapsed ? (
                <MenuOutlinedIcon style={{ color: "#fff" }}></MenuOutlinedIcon>
              ) : undefined
            }
            style={{
